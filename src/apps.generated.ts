...
const apps: AppConfig[] = [
  ...
  {
    "folder": "token-economics-agent-cost-estimator",
    "name": "AI for CFOs | Agentic AI Cost Estimator",
    ...
    "status": "live",
    "visibility": "public",
    "url": "/token-economics-agent-cost-estimator"
  },
  {
    "folder": "token-economics-executive-primer",
    "name": "AI for CFOs | Token Economics Executive Primer",
    "description": "Interactive AI token cost primer — explore pricing tiers, architecture levers, and the cost playground to model and optimise your AI spend.",
    "icon": "🪙",
    "accent": "#009A44",
    "tag": "Token Economics",
    ...
    "status": "live",
    "visibility": "public",
    "url": "/token-economics-executive-primer"
  }
];
